...
arms_horizontal_array = np.append(arms_front_array, arms_horizontal_01[60:-30,:], axis=0)
arms_horizontal_array = np.append(arms_front_array, arms_horizontal_02[60:-30,:], axis=0)
arms_horizontal_array = np.append(arms_front_array, arms_horizontal_03[60:-30,:], axis=0)
arms_horizontal_array = np.append(arms_front_array, arms_horizontal_04[60:-30,:], axis=0)
...
arms_side_array = np.append(arms_front_array, arms_side_01[60:-30,:], axis=0)
arms_side_array = np.append(arms_front_array, arms_side_02[60:-30,:], axis=0)
arms_side_array = np.append(arms_front_array, arms_side_03[60:-30,:], axis=0)
arms_side_array = np.append(arms_front_array, arms_side_04[60:-30,:], axis=0)
...
#merge table to one
frames = [ arms_side_df, arms_horizontal_df,arms_sky_df ]
...
balanced_data = balanced_data.append([arms_horizontal, arms_side, arms_sky])
...
X_train = X_train.reshape(367, 60, 6, 1)
X_test = X_test.reshape(92, 60, 6, 1)
...
fig, ax = plot_confusion_matrix(conf_mat=mat, class_names=label.classes_, show_normed=False, figsize=(3,3))
plt.show()
